        ...
        <div className="hero-grid" style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 400px", gap: 56, alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20, ...S.mono, fontSize: 10, letterSpacing: "0.14em", color: "var(--muted)" }}>
              ...
              <Link href={`/solutions`} style={{ color: "var(--muted)", textDecoration: "none" }}>솔루션</Link>
              <span style={{ opacity: 0.4 }}>›</span>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              <Link href={`/contact`} style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "linear-gradient(135deg,var(--teal),var(--cyan))", color: "var(--bg)", fontSize: 14, fontWeight: 500, padding: "13px 28px", borderRadius: 2, textDecoration: "none", fontFamily: "'Noto Sans KR',sans-serif" }}>
                {c.ctaPrimary}
              </Link>
