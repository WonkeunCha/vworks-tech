  ...
  return (
    <main style={{ minHeight: '100vh', background: '#050d1a', color: '#e8f1ff', paddingTop: 96, paddingBottom: 80, paddingLeft: 'clamp(16px,4vw,48px)', paddingRight: 'clamp(16px,4vw,48px)', fontFamily: "'Pretendard', sans-serif" }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        <Link href="/ko/notice/" style={{ fontFamily: 'monospace', fontSize: 10, letterSpacing: '0.15em', color: '#5a7a9a', textDecoration: 'none', display: 'block', marginBottom: 32 }}>← 공지사항 목록</Link>
        ...
        <div style={{ marginTop: 64, paddingTop: 32, borderTop: '1px solid rgba(31,74,117,.5)' }}>
          <Link href="/ko/notice/" style={{ fontFamily: 'monospace', fontSize: 10, letterSpacing: '0.15em', color: '#5a7a9a', textDecoration: 'none' }}>← 목록으로 돌아가기</Link>
        </div>
      </div>
    </main>
  );
