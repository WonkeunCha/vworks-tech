    ...
    <main className="min-h-screen bg-[#050d1a] text-[#e8f1ff]">
      ...
      <section className="pt-36 pb-20 px-10">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="font-['Bebas_Neue'] text-[72px] tracking-wide leading-[.92] mb-4">VWorks 솔루션<br /><span className="text-[42px] text-[rgba(200,220,255,.76)] font-['Noto_Sans_KR'] font-light tracking-normal">포트폴리오 전체</span></h1>
              ...
              const inner = (
                <>
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="font-['Bebas_Neue'] text-[28px] tracking-wide leading-none mb-3" style={{color:s.color}}>{s.name}</h2>
