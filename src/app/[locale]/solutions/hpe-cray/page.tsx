...
export default function HpeCrayPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050d1a] text-[#e8f1ff]">
      ...
      <section className="relative pt-24 pb-20 px-4 md:px-4 md:px-10 border-b border-[rgba(31,74,117,.5)] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-14 items-center">
          ...
          <div className="bg-[#0a1628] rounded-sm p-6 relative overflow-hidden" style={{ border: '1px solid rgba(1,169,130,.3)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 gap-[2px]">
              {[
      ...
      {/* ── TOP500 배너 ── */}
      <section className="px-4 md:px-4 md:px-10 py-12 reveal opacity-0 translate-y-5 transition-all duration-500">
      ...
      {/* ── 시스템 라인업 ── */}
      <section id="systems" className="px-4 md:px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2px]">
            {SYSTEMS.map((s) => (
          ...
          <div className="mt-[2px] p-7 bg-[#0a1628] border border-[rgba(31,74,117,.5)] rounded-sm flex flex-col lg:flex-row gap-6 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[2px] min-w-[300px]">
      ...
      {/* ── 아키텍처 ── */}
      <section id="architecture" className="px-4 md:px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500" style={{ background: 'linear-gradient(180deg,transparent,rgba(1,169,130,.03),transparent)' }}>
        <div className="max-w-6xl mx-auto">
      ...
      <section className="px-4 md:px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2px]">
            {SLINGSHOT.map((s) => (
      ...
      <section className="px-4 md:px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[2px] mb-6">
            {[
      ...
      <section className="px-4 md:px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[2px]">
            {[
      ...
      <section className="px-4 md:px-4 md:px-10 py-20 text-center reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 md:grid-cols-2 gap-[2px] max-w-sm mx-auto mb-8">
