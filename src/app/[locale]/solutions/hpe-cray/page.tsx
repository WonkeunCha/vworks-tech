    ...
    <main className="min-h-screen bg-[#050d1a] text-[#e8f1ff]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-14 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/ko/contact/" className="text-[#050d1a] text-[14px] font-medium px-7 py-3 rounded-sm" style={{ background: 'linear-gradient(135deg,#01A982,#00C9B1)' }}>도입 상담 신청 →</Link>
          ...
          <div className="flex flex-wrap items-center gap-8 p-7 rounded-sm" style={{ background: 'linear-gradient(135deg,rgba(1,169,130,.08),rgba(0,201,177,.05))', border: '1px solid rgba(1,169,130,.3)' }}>
            ...
            <div className="flex flex-wrap gap-2">
              {[['#1 El Capitan (USA)', '#01A982', 'rgba(1,169,130,.1)', 'rgba(1,169,130,.3)'], ['#2 Frontier (USA)', '#38D9F5', 'rgba(56,217,245,.07)', 'rgba(56,217,245,.2)'], ['#3 LUMI (EU)', '#00C9B1', 'rgba(0,201,177,.08)', 'rgba(0,201,177,.2)']].map(([t, c, bg, b]) => (
                <span key={t} className="font-mono text-[9px] px-3 py-1 rounded-sm whitespace-normal md:whitespace-nowrap"
      ...
      <section className="px-4 md:px-10 pb-20 reveal opacity-0 translate-y-5 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2px]">
            {SLINGSHOT.map((s) => (
